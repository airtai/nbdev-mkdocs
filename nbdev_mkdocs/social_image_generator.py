...
# %% auto 0
__all__ = ['IMG_Generator', 'generate_social_image']
...
def _generate_image_url(
    ...
    Returns:
        The image url
    """
    if generator not in IMG_Generator._member_names_:
        raise ValueError(
            "Invalid Option for generator. Valid options are: 'file' and 'dall_e'"
        )

    elif generator == IMG_Generator.dall_e.value:
