...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'nbdev_mkdocs._helpers.cli_doc': { 'nbdev_mkdocs._helpers.cli_doc._State': ( 'cli_doc_helper.html#_state',
                                               ...
                                               'nbdev_mkdocs._helpers.cli_doc.generate_cli_doc': ( 'cli_doc_helper.html#generate_cli_doc',
                                                                                                   'nbdev_mkdocs/_helpers/cli_doc.py')},
            'nbdev_mkdocs._helpers.utils': { 'nbdev_mkdocs._helpers.utils.get_value_from_config': ( 'utils.html#get_value_from_config',
            ...
            'nbdev_mkdocs.social_image_generator': { 'nbdev_mkdocs.social_image_generator._generate_ai_image': ( 'social_card_generator.html#_generate_ai_image',
                                                                                                                 'nbdev_mkdocs/social_image_generator.py'),
                                                     'nbdev_mkdocs.social_image_generator._generate_html': ( 'social_card_generator.html#_generate_html',
                                                                                                             'nbdev_mkdocs/social_image_generator.py'),
                                                     'nbdev_mkdocs.social_image_generator._generate_png_from_html': ( 'social_card_generator.html#_generate_png_from_html',
                                                                                                                      'nbdev_mkdocs/social_image_generator.py'),
                                                     'nbdev_mkdocs.social_image_generator._update_social_image_in_mkdocs_yml': ( 'social_card_generator.html#_update_social_image_in_mkdocs_yml',
                                                                                                                                 'nbdev_mkdocs/social_image_generator.py'),
                                                     'nbdev_mkdocs.social_image_generator._update_social_image_in_site_overrides': ( 'social_card_generator.html#_update_social_image_in_site_overrides',
                                                                                                                                     'nbdev_mkdocs/social_image_generator.py'),
                                                     'nbdev_mkdocs.social_image_generator.generate_custom_social_image': ( 'social_card_generator.html#generate_custom_social_image',
                                                                                                                           'nbdev_mkdocs/social_image_generator.py')}}}
