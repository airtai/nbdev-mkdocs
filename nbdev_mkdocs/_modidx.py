...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'nbdev_mkdocs._helpers.cli_doc': { 'nbdev_mkdocs._helpers.cli_doc._State': ( 'cli_doc_helper.html#_state',
            ...
            'nbdev_mkdocs.mkdocs': { 'nbdev_mkdocs.mkdocs._add_all_submodules': ( 'mkdocs.html#_add_all_submodules',
                                     ...
                                     'nbdev_mkdocs.mkdocs._add_markdown_attribute_to_enable_md_in_html': ( 'mkdocs.html#_add_markdown_attribute_to_enable_md_in_html',
                                                                                                           'nbdev_mkdocs/mkdocs.py'),
                                     ...
                                     'nbdev_mkdocs.mkdocs._expand_sidebar_if_needed': ( 'mkdocs.html#_expand_sidebar_if_needed',
                                                                                        'nbdev_mkdocs/mkdocs.py'),
                                     'nbdev_mkdocs.mkdocs._fix_sym_links': ('mkdocs.html#_fix_sym_links', 'nbdev_mkdocs/mkdocs.py'),
                                     ...
                                     'nbdev_mkdocs.mkdocs._get_api_summary_item': ( 'mkdocs.html#_get_api_summary_item',
                                                                                    'nbdev_mkdocs/mkdocs.py'),
                                     'nbdev_mkdocs.mkdocs._get_backtick_enclosed_string': ( 'mkdocs.html#_get_backtick_enclosed_string',
                                                                                            'nbdev_mkdocs/mkdocs.py'),
                                     'nbdev_mkdocs.mkdocs._get_current_docs_version': ( 'mkdocs.html#_get_current_docs_version',
                                                                                        'nbdev_mkdocs/mkdocs.py'),
                                     ...
                                     'nbdev_mkdocs.mkdocs._get_sym_path_from_nbdev_lookup': ( 'mkdocs.html#_get_sym_path_from_nbdev_lookup',
                                                                                              'nbdev_mkdocs/mkdocs.py'),
