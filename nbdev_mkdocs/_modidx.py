  ...
  'syms': { 'nbdev_mkdocs._helpers.cli_doc': { 'nbdev_mkdocs._helpers.cli_doc._State': ( 'cli_doc_helper.html#_state',
            ...
            'nbdev_mkdocs.mkdocs': { 'nbdev_mkdocs.mkdocs._add_requirements_to_settings': ( 'mkdocs.html#_add_requirements_to_settings',
                                     ...
                                     'nbdev_mkdocs.mkdocs._get_value_from_config': ( 'mkdocs.html#_get_value_from_config',
                                                                                     'nbdev_mkdocs/mkdocs.py'),
                                     'nbdev_mkdocs.mkdocs._patched_sprun': ('mkdocs.html#_patched_sprun', 'nbdev_mkdocs/mkdocs.py'),
                                     ...
                                     'nbdev_mkdocs.mkdocs._restrict_line_length': ( 'mkdocs.html#_restrict_line_length',
                                                                                    'nbdev_mkdocs/mkdocs.py'),
                                     'nbdev_mkdocs.mkdocs._sprun_1': ('mkdocs.html#_sprun_1', 'nbdev_mkdocs/mkdocs.py'),
