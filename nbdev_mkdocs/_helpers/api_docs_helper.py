...
# %% auto 0
__all__ = ['MKDOCS_LOCAL_CONFIG', 'ParameterKindMapper', 'get_formatted_docstring_for_symbol']
...
def get_formatted_docstring_for_symbol(
    ...
    contents = (
        f"::: {symbol.__module__}.{symbol.__qualname__}{MKDOCS_LOCAL_CONFIG}" + contents
    )
    return contents
