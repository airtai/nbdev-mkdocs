...
def _get_relative_sym_path(o: Any) -> str:
    ...
    return "/".join((o.__module__ + "." + o.__qualname__).split("."))

# %% ../../nbs/Doc_Links_Utils.ipynb 27
    ...
    for match in re.findall(pattern, s):
        ...
        if symbol_details is not None:
            updated_link = _update_link(
                symbol, symbol_details, nbdev_lookup, docs_versioning, lib_version
            )
