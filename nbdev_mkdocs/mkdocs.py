...
# %% ../nbs/Mkdocs.ipynb 5
def _add_requirements_to_settings(root_path: str) -> None:
    ...
    try:
        ...
        _new_req_to_add = "nbdev-mkdocs"
        option_name = "dev_requirements"
        ...
        if new_req in old_req:
            ...
            return
        req = old_req + " \\\n" + f"{new_req}>={nbdev_mkdocs.__version__}"
        req = textwrap.indent(req, " " * 4)
        updater["DEFAULT"][option_name] = Option(key=option_name, value=req)
...
def new_cli(root_path: str = ".") -> None:
    """Initialize mkdocs project files
...
@call_parse  # type: ignore
def nbdev_mkdocs_docs_cli(root_path: str = ".") -> None:
    """Prepare mkdocs documentation
...
@call_parse  # type: ignore
def prepare_cli(root_path: str = ".") -> None:
    """Prepare mkdocs for serving
...
@call_parse  # type: ignore
def preview_cli(root_path: str = ".", port: Optional[int] = None) -> None:
    """Preview the mkdocs documentation.
