...
# %% ../nbs/Mkdocs.ipynb 5
def _add_mkdocs_to_dev_requirements(root_path: str) -> None:
    """Adds nbdev-mkdocs library to the dev_requirments in settings.ini
...
def new(root_path: str) -> None:
    ...
    !!! note
        ...
        The above docstring is autogenerated by docstring-gen library (https://github.com/airtai/docstring-gen)
    """
    _add_mkdocs_to_dev_requirements(root_path)
